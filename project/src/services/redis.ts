...
export const CACHE_KEYS = {
  PERPLEXITY_TREND: (season: string, region: string, demographic: string) =>
    `trends:perplexity:${season}:${region}:${demographic}`,
  
  PERPLEXITY_CELEBRITY_TREND: (demographic: string) =>
    `perplexity:trend:celebrity:${demographic}`,
...
export const CACHE_TTL = {
  PERPLEXITY_TRENDS: 24 * 60 * 60, // 24 hours
