...
export class TechPackGenerator {
  async generateTechPack(item: CollectionItem): Promise<TechPack> {
    console.log('═══════════════════════════════════════════════════════════════');
    console.log(`📋 STEP 4: GENERATING TECH PACK FOR ${item.name.toUpperCase()}`);
    console.log('═══════════════════════════════════════════════════════════════');

    try {
      const prompt = this.buildTechPackPrompt(item);
      ...
      console.log('📥 GEMINI RESPONSE (truncated):');
      console.log(generatedText.substring(0, 500) + '...');
      console.log('───────────────────────────────────────────────────────────────');

      // Parse the generated text into structured tech pack
      const techPack = this.parseGeneratedTechPack(generatedText, item);
