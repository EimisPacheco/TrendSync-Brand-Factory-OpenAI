import { Home, Palette, Shield, Layers, TrendingUp, Settings, LogOut } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';

export type View = 'dashboard' | 'brand-style' | 'brand-guardian' | 'collection' | 'trends' | 'settings';
